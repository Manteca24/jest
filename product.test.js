...
describe('products management', () => {
    ...
    test('should increment the ID by 1 when adding a product', () => {
        addProduct('item1', 10);
        addProduct('item2', 20);
        const products = getProducts();
    ...
    test('should throw an error if price or name is not defined', () => {
    ...
    test('should get a product by its ID', () => {
        addProduct('item1', 10);
        const product = getProduct(1);
        expect(product).toEqual({ id: 1, name: 'item1', price: 10 });
    });

    test('should throw an error if the product does not exist when searched by ID', () => {
    ...
    test('should throw an error if the product to update does not exist', () => {
